...
$don_hangs = new don_hang();
$don_hang = $don_hangs->doc_don_hang();
?>
<!DOCTYPE HTML>
<html>
<head>
...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="trang_chu.php">Home</a> <i class="fa fa-angle-right"></i>Đơn hàng</li>
        </ol>
<!--four-grids here-->
		...
		<div class="w3l-table-info">
					  ...
					  <table id="table">
							...
							<tbody>
								<tr>
								<td><?php echo $dh['ma_hoa_don']?></td>
								<td><?php echo $dh['ma_khach_hang']?></td>
								<td><?php echo $dh['ngay_dat']?></td>
								<td><?php echo $dh['tong_tien']?></td>
								<td><?php echo $dh['ma_trang_thai']?></td>
								</tr>
							</tbody>
							<?php
								}
