...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="trang_chu.php">Home</a> <i class="fa fa-angle-right"></i>Sửa Game</li>
        </ol>
<!--four-grids here-->
		...
		<div class="w3l-table-info">
						...
						<table id="table">
								...
								<tbody>
									...
									<td><a href="javascript:Sua_Game(<?php echo $d['ma_game']?>)">Sửa</a></td>
									</tr>
								</tbody>
								<?php
									}
